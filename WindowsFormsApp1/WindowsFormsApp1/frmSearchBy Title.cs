...
{
    public partial class frmSearchBy_Title : Form
    {
        public frmSearchBy_Title()
        {
            InitializeComponent();
        }
        ...
        public void funSearchByTitle(String txt,int title)
        {
            ...
            try
            {
              ...
              // = new MySqlDataAdapter("Select * From student.phone_service-table where phone_number like'" + txt + "'", con);
                switch (title)
                {
                    case 0:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where customer_id like'" + txt+"'", con);
                             break;
                    case 1:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where customer_name like'" + txt + "%'", con);
                             break;
                    case 2:  adapter2 = new MySqlDataAdapter("Select * from student.phone_service_table where phone_number like'" + txt + "%'", con);
                             break;
                    case 3:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where technical_name like'" + txt + "%'", con);
                             break;
                    case 4:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where device_model like'" + txt + "%'", con);
                             break;
                    case 5:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where device_color like'" + txt+"%'" , con);
                             break;
                    case 6:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where imei_1 like'" + txt+"%'" , con);
                             break;
                    case 7:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where imei_2 like'" + txt+"%'" , con);
                             break;
                    case 8:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where device_error like'" + txt + "%'", con);
                             break;
                    case 9:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where password_lock like'" + txt+"%'" , con);
                             break;
                    case 10: adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where sim_card like'" + txt + "%'", con);
                             break;
                    case 11: adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where sd_card like'" + txt + "%'", con);
                             break;
                   ...
                   // case 13: MySqlDataAdapter adapter = new MySqlDataAdapter("Select * From student.phone_service-table where phone_number like'" + txt + "'", con);
                    ...
                    //case 14: MySqlDataAdapter adapter = new MySqlDataAdapter("Select * From student.phone_service-table where phone_number like'" + txt + "'", con);
                            //break;
                    case 12:  adapter2 = new MySqlDataAdapter("Select * From student.phone_service_table where amount like'" + txt+"'", con);
                             break; 
